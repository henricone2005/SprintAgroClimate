...
using Microsoft.EntityFrameworkCore;                          // Usado para o Entity Framework Core
using AgroClimate.Data;                                      // Namespace para o contexto de dados
...
builder.Services.AddDbContext<ApplicationDbContext>(options =>
    options.UseOracle(builder.Configuration.GetConnectionString("DefaultConnection"))); // Configuração do DbContext para Oracle
